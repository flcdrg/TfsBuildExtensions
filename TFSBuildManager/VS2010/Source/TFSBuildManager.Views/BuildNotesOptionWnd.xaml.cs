//-----------------------------------------------------------------------
// <copyright file="BuildNotesOptionWnd.xaml.cs">(c) http://TfsBuildExtensions.codeplex.com/. This source is subject to the Microsoft Permissive License. See http://www.microsoft.com/resources/sharedsource/licensingbasics/sharedsourcelicenses.mspx. All other rights reserved.</copyright>
//-----------------------------------------------------------------------
namespace TfsBuildManager.Views
{
    ...
    /// <summary>
    /// Interaction logic for BuildNotesOptionWnd.xaml
    /// </summary>
    public partial class BuildNotesOptionWnd
    {
        ...
        private void OnGenerate(object sender, RoutedEventArgs e)
        {
            ...
            SetOption(this.cbCheckIntoTfs, ref options, BuildNoteOptions.CheckIntoTfs.ToString());
